...
<p center>
  ...
  <a href="https://github.com/ishandutta2007/Awesome-AI-Compliance-Platform/stargazers"><img src="https://img.shields.io/github/stars/ishandutta2007/Awesome-AI-Compliance-Platform?style=flat-square&color=gold" alt="Stars"/></a>
  <a href="https://github.com/ishandutta2007/Awesome-AI-Compliance-Platform/network/members"><img src="https://img.shields.io/github/forks/ishandutta2007/Awesome-AI-Compliance-Platform?style=flat-square&color=blue" alt="Forks"/></a>
  <a href="https://github.com/ishandutta2007/Awesome-AI-Compliance-Platform/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-MIT-green.svg?style=flat-square" alt="License"/></a>
  <a href="https://github.com/ishandutta2007"><img alt="GitHub followers" src="https://img.shields.io/github/followers/ishandutta2007?label=Follow" /></a>
</p>

![Awesome AI Compliance Platform Banner](assets/banner.svg)
...
| **[evidentlyai/evidently](https://github.com/evidentlyai/evidently)** | Open-source ML and LLM evaluation suite for data drift monitoring, performance auditing, and technical evidence generation. | [![Stars](https://img.shields.io/github/stars/evidentlyai/evidently?style=social&color=white)](https://github.com/evidentlyai/evidently/stargazers) |
| **[guardrails-ai/guardrails](https://github.com/guardrails-ai/guardrails)** | Open-source framework for validating and structuring LLM outputs, enforcing safety policies, and logging compliance controls. | [![Stars](https://img.shields.io/github/stars/guardrails-ai/guardrails?style=social&color=white)](https://github.com/guardrails-ai/guardrails/stargazers) |
| **[NVIDIA/NeMo-Guardrails](https://github.com/NVIDIA/NeMo-Guardrails)** | Toolkit for adding programmable guardrails to LLM applications to ensure conversational safety, topic enforcement, and control logging. | [![Stars](https://img.shields.io/github/stars/NVIDIA/NeMo-Guardrails?style=social&color=white)](https://github.com/NVIDIA/NeMo-Guardrails/stargazers) |
| **[giskard-ai/giskard](https://github.com/giskard-ai/giskard)** | Open-source testing framework for AI models to detect hallucination, bias, security vulnerabilities, and compliance flaws. | [![Stars](https://img.shields.io/github/stars/giskard-ai/giskard?style=social&color=white)](https://github.com/giskard-ai/giskard/stargazers) |
| **[deepchecks/deepchecks](https://github.com/deepchecks/deepchecks)** | Continuous validation library for machine learning models and LLMs to automate QA, data integrity, and compliance reporting. | [![Stars](https://img.shields.io/github/stars/deepchecks/deepchecks?style=social&color=white)](https://github.com/deepchecks/deepchecks/stargazers) |
| **[truera/trulens](https://github.com/truera/trulens)** | Open-source instrumentation toolkit for evaluating, tracking, and auditing LLM applications and RAG chains against risk standards. | [![Stars](https://img.shields.io/github/stars/truera/trulens?style=social&color=white)](https://github.com/truera/trulens/stargazers) |
| **[protectai/llm-guard](https://github.com/protectai/llm-guard)** | Security toolkit for LLMs designed to sanitize prompts and outputs against toxicity, prompt injection, and PII leakage. | [![Stars](https://img.shields.io/github/stars/protectai/llm-guard?style=social&color=white)](https://github.com/protectai/llm-guard/stargazers) |
| **[tensorflow/model-card-toolkit](https://github.com/tensorflow/model-card-toolkit)** | Standardized toolkit for automating the generation of Model Cards to satisfy model documentation requirements. | [![Stars](https://img.shields.io/github/stars/tensorflow/model-card-toolkit?style=social&color=white)](https://github.com/tensorflow/model-card-toolkit/stargazers) |
| **[SdSarthak/AegisAI](https://github.com/SdSarthak/AegisAI)** | Open-source AI-GRC platform oriented to EU AI Act workflows—system registration, risk classification, and technical documentation. | [![Stars](https://img.shields.io/github/stars/SdSarthak/AegisAI?style=social&color=white)](https://github.com/SdSarthak/AegisAI/stargazers) |
...
[![Star History Chart](https://star-history.dera.page/svg?repos=ishandutta2007/Awesome-AI-Compliance-Platform&type=date&legend=top-left)](https://star-history.dera.page/#ishandutta2007/Awesome-AI-Compliance-Platform&type=date&legend=top-left)
